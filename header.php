...
<meta property="fb:pages" content="103630105150174" />
    <?php 
        if($post->ID<>""){
            ...
            $stcontents="BKC is the digital crypto currency executing on secure block-chain technology which is allowed user to perform immediate cashless payment transaction via Web, Windows, Mac, Linux, Andriod and iOS wallet embedding with digital signature feature.";
        }
    ?>   
    ...
    <meta property="og:site_name" content="Briskcoin (BKC)" />
...
<meta name="keywords" content="Briskcoin Digtial Currency BKC Crypto Currency" />	
